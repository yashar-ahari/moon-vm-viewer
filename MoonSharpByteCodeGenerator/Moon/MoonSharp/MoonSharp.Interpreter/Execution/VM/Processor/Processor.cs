...
namespace MoonSharp.Interpreter.Execution.VM
{
	sealed partial class Processor
	{
		...
		public Processor(Script script, Table globalContext, ByteCode byteCode)
		{
			...
			script.ProcessorDebugContext.v_Stack = m_ValueStack;
			script.ProcessorDebugContext.e_Stack = m_ExecutionStack;
		}
		...
		internal void SetDebugProcessorReferences(ProcessorDebugContext debugContext)
		{
			debugContext.v_Stack = m_ValueStack;
			debugContext.e_Stack = m_ExecutionStack;
		}
