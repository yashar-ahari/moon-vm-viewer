...
using MoonSharpByteCodeGenerator.Moon.MoonSharp.MoonSharp.Interpreter.Execution.VM;
...
namespace MoonSharp.Interpreter
{
	...
	public class Script : IScriptPrivateResource
	{
		...
		public ProcessorDebugContext ProcessorDebugContext;
		...
		{
            ProcessorDebugContext = new ProcessorDebugContext(this);
		...
		public void DumpByteCode(string file)
		{
			m_ByteCode?.Dump(file);
		}

		public string? DumpByteCode(ref int offset, bool rootChunkOnly = false)
		{
			return m_ByteCode?.Dump(ref offset, rootChunkOnly);
		}
